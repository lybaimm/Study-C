    ...
    void display() {
        ...
        if (front == -1 || front > rear) {
            ...
            for (int i = front; i <= rear; i++) {
                cout << setw(3) << nomor << " | " << pasien[i] << endl;
                nomor++;
            }
        }
        cout << string(50, '=') << endl;
...
struct Stack {
    ...
    // Push - Menambah riwayat pemeriksaan
    ...
    // Tampilkan riwayat (LIFO - Last In First Out)
    void display() {
        cout << "\n" << string(50, '=') << endl;
        ...
        if (top == -1) {
            ...
            cout << string(50, '-') << endl;
            int nomor = 1;
            // Tampilkan dari atas stack (terakhir diperiksa)
            for (int i = top; i >= 0; i--) {
                cout << setw(3) << nomor << " | " << riwayat[i];
